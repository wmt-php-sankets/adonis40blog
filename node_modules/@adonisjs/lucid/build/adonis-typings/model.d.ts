...
declare module '@ioc:Adonis/Lucid/Model' {
    ...
    import { ModelRelations, RelationOptions, PreloaderContract, ModelRelationTypes, QueryBuilderPreloadFn, RelationshipsContract, ExtractModelRelations, ThroughRelationOptions, ManyToManyRelationOptions } from '@ioc:Adonis/Lucid/Relations';
    /**
     * ------------------------------------------------------
     *  Helpers
     * ------------------------------------------------------
    ...
    type ModelAttributes<Model extends LucidRow> = Model['$columns'] extends undefined ? {
        [Filtered in {
            [P in keyof Model]: P extends keyof LucidRow ? never : Model[P] extends Function | ModelRelationTypes ? never : P;
     ...
     */
    interface ModelBuilderPreloadFn<Model extends LucidRow> extends QueryBuilderPreloadFn<Model, Promise<void>> {
    ...
    interface LucidModel {
         ...
         */
        $addRelation(name: string, type: ModelRelations['type'], relatedModel: () => LucidModel, options: ModelRelationOptions): void;
        /**
        ...
        before<Model extends LucidModel>(this: Model, event: 'paginate', handler: HooksHandler<[ModelQueryBuilderContract<Model>, ModelQueryBuilderContract<Model>], 'paginate'>): void;
         ...
         */
        firstOrFail<T extends LucidModel>(this: T, options?: ModelAdapterOptions): Promise<null | InstanceType<T>>;
        /**
         ...
         * one's.
         */
        fetchOrNewUpMany<T extends LucidModel>(this: T, uniqueKey: keyof ModelAttributes<InstanceType<T>>, payload: Partial<ModelAttributes<InstanceType<T>>>[], options?: ModelAdapterOptions): Promise<InstanceType<T>[]>;
        /**
         * Find rows or create many when missing. One db call is invoked
         * for each create
         */
        fetchOrCreateMany<T extends LucidModel>(this: T, uniqueKey: keyof ModelAttributes<InstanceType<T>>, payload: Partial<ModelAttributes<InstanceType<T>>>[], options?: ModelAdapterOptions): Promise<InstanceType<T>[]>;
        /**
         * Update existing rows or create new one's.
         */
        updateOrCreateMany<T extends LucidModel>(this: T, uniqueKey: keyof ModelAttributes<InstanceType<T>>, payload: Partial<ModelAttributes<InstanceType<T>>>[], options?: ModelAdapterOptions): Promise<InstanceType<T>[]>;
        /**
         * Fetch all rows
         */
    ...
    type OrmConfig = {
         ...
         */
        getLocalKey(relation: ModelRelations['type'], model: LucidModel, relatedModel: LucidModel): string;
        /**
         * Return the foreign key property name for a given relationship
         */
        getForeignKey(relation: ModelRelations['type'], model: LucidModel, relatedModel: LucidModel): string;
        /**
