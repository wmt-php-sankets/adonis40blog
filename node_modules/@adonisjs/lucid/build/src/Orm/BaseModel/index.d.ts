...
export declare class BaseModel implements LucidRow {
     ...
     * Adds a relationship
     */
    static $addRelation(name: string, type: ModelRelations['type'], relatedModel: () => LucidModel, options: ModelRelationOptions): void;
    /**
     ...
     */
    static fetchOrNewUpMany(uniqueKey: any, payload: any, options?: ModelAdapterOptions): Promise<any[]>;
    /**
     ...
     * hooks.
     */
    static fetchOrCreateMany(uniqueKey: any, payload: any, options?: ModelAdapterOptions): Promise<any[]>;
    /**
     ...
     * of model hooks.
     */
    static updateOrCreateMany(uniqueKey: any, payload: any, options?: ModelAdapterOptions): Promise<any>;
    /**
     ...
     * locally
     */
    fill(values: any, allowNonExtraProperties?: boolean): void;
    /**
     ...
     * 2. If key is defined as a relationship, it will be ignored and one must call `$setRelated`.
     */
    merge(values: any, allowNonExtraProperties?: boolean): void;
    /**
