...
let BaseModel = /** @class */ (() => {
    ...
    let BaseModel = BaseModel_1 = class BaseModel {
         ...
         * many.
         */
        static newUpIfMissing(rowObjects, existingRows, key, mergeAttribute, options) {
            /**
            ...
            return rowObjects.map((rowObject) => {
                ...
                const existingRow = existingRows.find((one) => one[key] == rowObject[key]);
                /**
        ...
        static boot() {
            ...
            Object.defineProperty(this, '$hooks', {
                value: new hooks_1.Hooks(this.$container.getResolver(undefined, 'modelHooks', 'App/Models/Hooks')),
            });
         ...
         */
        static async fetchOrNewUpMany(uniqueKey, payload, options) {
            /**
             * Ensure value for the unique key inside the array is not
             * null or undefined
             */
            const uniqueKeyValues = utils_2.collectValues(payload, uniqueKey, () => {
         ...
         * hooks.
         */
        static async fetchOrCreateMany(uniqueKey, payload, options) {
            /**
         ...
         * of model hooks.
         */
        static async updateOrCreateMany(uniqueKey, payload, options) {
            /**
             * An array of values for the unique key
             */
            const uniqueKeyValues = utils_2.collectValues(payload, uniqueKey, () => {
