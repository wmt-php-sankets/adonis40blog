...
class ManyToMany {
    constructor(relationName, relatedModel, options, model) {
        ...
        this.booted = false;
        this.serializeAs = this.options.serializeAs === undefined
            ? this.relationName
    ...
    boot() {
        ...
        this.pivotTable = this.options.pivotTable || this.model.$configurator.getPivotTableName(this.type, this.model, relatedModel, this.relationName);
        /**
