...
class ManyToManyQueryClient {
     ...
     */
    getRelatedForeignKeyValue(related, action) {
        return utils_1.getValue(related, this.relation.relatedKey, this.relation, action);
    }
    /**
    ...
    async sync(ids, detach = true, trx) {
        await utils_1.managedTransaction(trx || this.client, async (transaction) => {
             ...
             */
            const pivotRows = !hasAttributes ? ids.reduce((result, id) => {
                result[id] = {};
                return result;
            }, {}) : ids;
