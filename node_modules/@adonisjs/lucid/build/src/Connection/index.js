...
class Connection extends events_1.EventEmitter {
    ...
    setupWriteConnection() {
        this.client = knex_1.default(Object.assign({ log: new Logger_1.Logger(this.name, this.logger) }, this.getWriteConfig(), { debug: false }));
    ...
    setupReadConnection() {
        ...
        this.readClient = knex_1.default(Object.assign({ log: new Logger_1.Logger(this.name, this.logger) }, this.getReadConfig(), { debug: false }));
    ...
    async checkReadHosts() {
        const configCopy = Object.assign({ log: new Logger_1.Logger(this.name, this.logger) }, this.config, { debug: false });
        let error = null;
