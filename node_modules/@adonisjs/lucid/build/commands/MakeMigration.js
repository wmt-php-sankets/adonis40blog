...
let MakeMigration = /** @class */ (() => {
    let MakeMigration = class MakeMigration extends ace_1.BaseCommand {
    ...
    __decorate([
        ace_1.args.string({ description: 'Name of the migration file' }),
        __metadata("design:type", String)
    ], MakeMigration.prototype, "name", void 0);
    __decorate([
        ace_1.flags.string({ description: 'Define a custom database connection for the migration' }),
        __metadata("design:type", String)
    ], MakeMigration.prototype, "connection", void 0);
    __decorate([
        ace_1.flags.string({ description: 'Pre-select a migration directory' }),
        __metadata("design:type", String)
    ], MakeMigration.prototype, "folder", void 0);
    __decorate([
        ace_1.flags.string({ description: 'Define the table name for creating a new table' }),
        __metadata("design:type", String)
    ], MakeMigration.prototype, "create", void 0);
    __decorate([
        ace_1.flags.string({ description: 'Define the table name for altering an existing table' }),
        __metadata("design:type", String)
    ], MakeMigration.prototype, "table", void 0);
    MakeMigration = __decorate([
