 ...
 */
let Migrate = /** @class */ (() => {
    let Migrate = class Migrate extends Base_1.default {
    ...
    __decorate([
        ace_1.flags.boolean({ description: 'Explictly force to run migrations in production' }),
        __metadata("design:type", Boolean)
    ], Migrate.prototype, "force", void 0);
    __decorate([
        ace_1.flags.boolean({ description: 'Print SQL queries, instead of running the migrations' }),
        __metadata("design:type", Boolean)
